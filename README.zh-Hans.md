...
<img src="docs/screenshots/hero.png" alt="TempoTerm 把终端、编辑器、文件管理器与 AI 助手放在同一个窗口" width="860" />
...
![自由分割布局，终端与代码编辑器并排](docs/screenshots/terminal-split.png)
...
![模糊搜索文件](docs/screenshots/fuzzy-find.png)
...
![Git 提交图](docs/screenshots/git-graph.png)
...
![AI 助手面板与 Markdown 回复](docs/screenshots/ai-assistant.png)
...
![主题与语言设置](docs/screenshots/themes.png)
